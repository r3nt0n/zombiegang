...
class Zombie{
    ...
    function usernameExists(){
        ...
        $query = "SELECT id, username, current_public_ip, current_hostname, current_mac_addr
    ...
    function read($filter_by_username=False, $filter_by_datetime_bef=False,$filter_by_datetime_aft=False , $order_by='id'){
        ...
        // query
        $query = "SELECT id, username, registered_at, current_public_ip, current_hostname, current_mac_addr, refresh_secs
                FROM " . $this->table_name . "
                {$filter}
                {$order_by} DESC";
